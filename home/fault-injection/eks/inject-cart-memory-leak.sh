...
NAMESPACE="carts"
DEPLOYMENT="carts"
BACKUP_FILE="$HOME/fault-injection/eks/manifests/carts-original.yaml"
...
generate_k8s_traffic_burst "$NAMESPACE" "carts" 8084 "/carts" 10 2>/dev/null || true
...
echo ""
echo "Rollback:"
echo "  ~/fault-injection/eks/rollback-cart-memory-leak.sh"
