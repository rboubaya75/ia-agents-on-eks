...
variable "security_group_id" {
  description = "Security group ID for the ECS tasks (required)"
  type        = string
}

variable "linux_capabilities_add" {
  description = "List of Linux capabilities to add to the container (e.g., NET_ADMIN for network manipulation)"
  type        = list(string)
  default     = []
}
