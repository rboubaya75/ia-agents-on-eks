        ...
        *,
        ...
        try:
            ...
            if (
                ...
                or _string(marker_item.get("tenantId"), "tenantId") != str(generation.tenant_id)
                or _string(marker_item.get("fingerprint"), "fingerprint") != generation.fingerprint
                or _string(marker_item.get("jobId"), "jobId") != str(succeeded_job.job_id)
                or _string(marker_item.get("status"), "status") != IngestionStatus.SUCCEEDED.value
